...
const InputText = () => {
  ...
  return (
    <View>
      ...
      <TextInput style={{fontSize:20,borderWidth:2,borderColor:'green',margin:15}}value={username} placeholder='Enter your username' onChangeText={(value)=>setUserName(value)}/>
