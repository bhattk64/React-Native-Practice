    ...
    <View className="flex-1 justify-center items-center bg-gray-900">
      <View className="w-16 h-64 relative ">
        <Animated.View
          ...
          className={
            'absolute top-0 w-full h-full bg-white rounded-lg shadow-lg justify-center'
          }>
          <Image
            source={frontImage}
            ...
            resizeMode="cover"
          />
          <Text className="text-center text-lg font-bold mt-3 text-gray-800">
      ...
      <TouchableOpacity
        onPress={handleFlip}
        className="bg-indigo-500 py-3 rounded-lg mt-8 px-4">
